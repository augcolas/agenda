...
ALTER TABLE ONLY "public"."event_users_user"
ADD CONSTRAINT "FK_a79703c5a43b536a49e3e4713ea"
FOREIGN KEY ("userId") REFERENCES "user"("id") NOT DEFERRABLE;

ALTER TABLE ONLY "public"."event_users_user"
ADD CONSTRAINT "FK_ddfe947d856e921a02d7ab2369"
